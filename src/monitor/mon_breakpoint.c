...
static
int breakpoint_add_checkpoint(int bank, MON_ADDR start_addr, MON_ADDR end_addr,
...
int mon_breakpoint_add_checkpoint(int bank, MON_ADDR start_addr, MON_ADDR end_addr,
                                  bool stop, MEMORY_OP op, bool is_temp)
{
    return breakpoint_add_checkpoint(bank, start_addr, end_addr, stop, op, is_temp, TRUE);
}
...
void mon_breakpoint_set(MON_ADDR address)
{
    ...
    if (ptr) {
        ...
        breakpoint_add_checkpoint(0, address, address,
