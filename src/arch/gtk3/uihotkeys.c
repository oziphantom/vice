...
static const hotkey_info_t hotkeys_list[] = {
    /* Quit, pause, reset */
    { VICE_MOD_MASK, "X", "Quit emulator" },
    { VICE_MOD_MASK, "R", "Soft reset" },
    { VICE_MOD_MASK, "Shift+R", "Hard reset" },
    ...
    /* controllers */
    { VICE_MOD_MASK, "H", "Enable mouse grab" },
    ...
    /* others */
    { VICE_MOD_MASK, "Return", "Toggle fullscreen mode" },
